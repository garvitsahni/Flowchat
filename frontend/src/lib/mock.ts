...
const DEPTH_PROFILE: QueryResponse = {
  ...
  chart_data: {
    ...
    stats: {
      temperature_c: { min: 6.1, max: 30.4, mean: 18.1, count: 11 },
      salinity_psu: { min: 33.4, max: 35.3, mean: 34.9, count: 11 },
      depth_m: { min: 0, max: 2000, mean: 555, count: 11 },
    },
  },
  confidence: "high",
  confidence_note: "",
...
const TRAJECTORY: QueryResponse = {
  ...
  chart_data: {
    ...
    float_id: "2900226",
    stats: {
      lat: { min: 6.0, max: 12.5, mean: 9.0, count: 11 },
      lon: { min: 85.0, max: 90.1, mean: 87.5, count: 11 },
    },
  },
  confidence: "high",
  confidence_note: "",
...
export const TIME_SERIES: QueryResponse = {
  ...
  chart_data: {
    ...
    region: "Bay of Bengal",
    stats: {
      value: { min: 20.7, max: 27.4, mean: 24.4, count: 8 },
    },
    trend: [20.7, 21.5, 22.3, 23.1, 23.9, 24.7, 25.5, 26.3],
  },
  confidence: "low",
  confidence_note:
